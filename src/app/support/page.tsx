...
export const metadata: Metadata = buildMetadata({
  title: "Support — Fixes for the common issues",
  description:
    "Fixes for the issues people actually hit: a lock that won't lift, a forgotten password, a missing purchase — and how to reach a human when they don't.",
  path: "/support",
});
      ...
      <main>
        <div className="cp">
          <div className="cp-wrap">
            ...
            <h1 className="cp-h1">Support</h1>
            <p className="cp-lead">
              The issues people actually hit, with the fix for each — and a
              direct line to a human for everything else.
            </p>
            <p className="cp-sub">
